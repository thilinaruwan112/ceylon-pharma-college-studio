...
function SubmitButton() {
  ...
  return (
    <Button type="submit" disabled={pending} size="icon" className="absolute right-1 top-1/2 h-10 w-10 -translate-y-1/2 rounded-lg bg-white text-primary hover:bg-gray-200">
...
export default function CertificateVerifier() {
  ...
  return (
    <section id="verify" className="bg-[#14b8a6] py-16 md:py-24 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <form action={formAction} className="mt-8 max-w-xl mx-auto">
                <div className="relative">
                  <Input 
                    ...
                    className="h-14 w-full rounded-lg border-2 border-white/50 bg-white/90 pl-6 pr-16 text-base text-gray-800 placeholder:text-gray-500 focus:border-white focus:bg-white focus:ring-2 focus:ring-white/50"
                  />
                  <SubmitButton />
                </div>
            ...
            {state.message && state.status && (
              <div className="mt-6">
                <div className={`inline-flex items-center gap-2 rounded-md px-4 py-2 ${state.status === 'success' ? 'bg-white/10' : 'bg-red-500/20'}`}>
            ...
            <p className="mt-8 max-w-3xl mx-auto text-white/80 text-sm font-body leading-relaxed">
